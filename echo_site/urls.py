...
urlpatterns = [
    ...
    #增加巡检子url，该子url下挂smogginfo,dcogginfo,ttogginfo
    url(r'^inspection/lists/(?P<table>\w+)/$', echo.views.lists, name='ogglists'),
    #增加内容
    ...
    #远程管理
    url(r'^remote_execution/$',echo.views.remote_execution, name='remote_execution'),
