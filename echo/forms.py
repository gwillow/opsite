...
from .models import Node,Line,Device,Employee,CompareCount,OggInfo
...
class CompareCountForm(ModelForm):
    class Meta:
        model = CompareCount
        exclude = ['comparecount_src']

class OggInfoForm(ModelForm):
    class Meta:
        model = OggInfo
        exclude = ['ogginfo_type']
